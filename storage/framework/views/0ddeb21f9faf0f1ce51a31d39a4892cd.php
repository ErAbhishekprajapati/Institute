    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">
                <img src="<?php echo e(asset('images/logo.jpeg')); ?>" alt="Logo">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown <?php echo e(Request::is('courses/*') ? 'active' : ''); ?>">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Courses
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo e(url ('web_development')); ?>">Web Development</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(url ('data_science')); ?>">Data Science</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(url ('o_level')); ?>">O level</a></li>
...
<?php /**PATH C:\laravel-projects\blog\resources\views/layouts/app.blade.php ENDPATH**/ ?>